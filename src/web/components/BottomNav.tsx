...
export function BottomNav() {
  ...
  return (
    <nav className="flex shrink-0 gap-1 bg-card px-3 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-2 shadow-[0_-1px_2px_rgba(15,23,42,0.04),0_-4px_16px_-4px_rgba(15,23,42,0.06)]">
